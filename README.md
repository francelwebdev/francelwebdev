...
La raison pour laquel j'aime tant Ruby est la lisibilité du code. Les points virgules, les parenthèses, et les accolades qui sont obligatoire en PHP me dégoûte, en Ruby elles sont pas obligatoire (je vous invite a jeter un coup d'oeil à un code Ruby et PHP sur le web, vous comprendez).
